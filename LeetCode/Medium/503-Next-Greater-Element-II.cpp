...
// Approach : Using brute-force approach we will get O(n^2) Time complxity and we might get TLE in some cases. So, to solve this problem efficientl we will use stack(LIFO) to reduce the Time complexity to O(n)
...
//            we will start from the end of given vector and iterate in reverse direction.
//                        
